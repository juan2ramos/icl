<?php get_header(); ?>
    ...
    <div class="benefit" id="beneficios">
        <h2>Beneficios</h2>
        <ul>
            <li> <span class="benefit-item"></span>ICL Desarrollo Urbano, es una empresa conformada por un equipo capacitado para planear, diseñar, construir
                y promover proyectos urbanísticos integrales
            </li>
            <li> <span class="benefit-item"></span>ICL Desarrollo Urbano, es una empresa conformada por un equipo capacitado para planear, diseñar, construir
                y promover proyectos urbanísticos integrales
            </li>
    ...
    <section class="about" id="nosotros">
        <div class="about-content">
            ...
            <p> ICL Desarrollo Urbano, es una empresa conformada por un equipo capacitado para planear, diseñar, construir
